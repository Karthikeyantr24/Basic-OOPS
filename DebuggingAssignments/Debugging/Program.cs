...
namespace Debugging
{
    class Program
    {
        ...
        static void StudentRegistration()
        {
            ...
            //Date Of Birth
            DateTime dob ;
                bool date = DateTime.TryParseExact(Console.ReadLine(),"dd/MM/yyyy",null,System.Globalization.DateTimeStyles.None,out dob);
                while(!date)
                {
                    System.Console.WriteLine("Invalid Input. Enter a correct option");
                    date = DateTime.TryParseExact(Console.ReadLine(),"dd/MM/yyyy",null,System.Globalization.DateTimeStyles.None,out dob);
                }
            //
            //
            //
